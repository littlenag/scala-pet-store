...
object LoggerFactory {
  ...
  lazy val consoleAppender: log4javascript.Appender = new log4javascript.BrowserConsoleAppender
  lazy val popupAppender: log4javascript.Appender = new log4javascript.PopUpAppender
